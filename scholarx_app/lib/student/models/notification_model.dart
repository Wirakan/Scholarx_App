...
//   - เพิ่ม copyWith() ใน NotificationItem (ใช้ใน provider ตอน markRead)
...
// ─── NotificationModel (ใช้กับ detail screen — ไม่เปลี่ยน) ─────────────────
...
// ─── NotificationItem (ใช้ใน list + provider) ────────────────────────────────
...
class NotificationItem {
  ...
  // เพิ่ม copyWith — ใช้ใน NotificationProvider.markRead()
